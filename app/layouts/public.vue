  ...
  <div class="public-shell">
    <header class="site-header">
      ...
      <div class="header-actions">
        <NuxtLink class="book" to="/boeken">{{ data?.content.publicCopy.navigation.booking || 'Boeken' }} <span aria-hidden="true">↗</span></NuxtLink>
        <button
          class="menu"
          type="button"
    ...
    <footer class="footer">
      <div class="footer-primary">
        ...
        <NuxtLink class="footer-cta" to="/boeken">{{ data?.content.publicCopy.footer.cta }} <span aria-hidden="true">→</span></NuxtLink>
      </div>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-links">
          <a v-if="data?.content.instagramUrl" :href="data.content.instagramUrl" target="_blank" rel="noreferrer">{{ data.content.publicCopy.footer.instagram }}</a>
          <a v-if="data?.content.spotifyUrl" :href="data.content.spotifyUrl" target="_blank" rel="noreferrer">{{ data.content.publicCopy.footer.spotify }}</a>
          <a v-if="data?.content.contactEmail" :href="`mailto:${data.content.contactEmail}`">{{ data.content.publicCopy.footer.email }}</a>
        </div>
      </div>
    </footer>
  </div>
...
@media(prefers-reduced-motion:reduce){.menu-panel-enter-active,.menu-panel-leave-active,.book,.desktop-nav a,.desktop-nav a::after,.footer-cta span{transition:none}.book:hover,.footer-cta:hover span{transform:none}}
</style>
