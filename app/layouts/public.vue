  ...
  <div class="public-shell">
    <header class="site-header">
      ...
      <div class="header-actions">
        <NuxtLink class="book" to="/boeken">Boeken <span aria-hidden="true">↗</span></NuxtLink>
        <button
          class="menu"
          type="button"
    ...
    <Transition name="menu-panel">
      <nav v-if="menuOpen" class="mobile-nav" aria-label="Mobiele navigatie">
        ...
        <NuxtLink class="mobile-book" to="/boeken">
          <span>Een avond plannen?</span>
          <strong>Boek NightLight →</strong>
        </NuxtLink>
      </nav>
    </Transition>
    ...
    <footer class="footer">
      <div class="footer-primary">
        <div>
          <p class="eyebrow">DJ NightLight · Groningen</p>
          <strong>Van eerste plaat<br>tot laatste dans.</strong>
        </div>
        <NuxtLink class="footer-cta" to="/boeken">Vertel over je feest <span aria-hidden="true">→</span></NuxtLink>
      </div>
