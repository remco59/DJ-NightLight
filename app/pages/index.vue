  ...
  <div v-if="content">
    ...
    <section v-if="recentGigData?.gigs.length" class="recent-nights public-container" aria-labelledby="recent-nights-title">
      <div class="recent-nights-intro">
        ...
        <h2 id="recent-nights-title">Echte avonden,<br>niet alleen sfeerbeelden.</h2>
        <p>Deze boekingen stonden openbaar in NightLight en zijn inmiddels geweest.</p>
      </div>
