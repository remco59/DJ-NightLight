...
<header class="page-header"><div><p class="eyebrow">Operations</p><h1>Venues</h1><p>Locations, contacts and practical notes.</p></div><button class="with-icon primary" @click="showCreate=!showCreate"><Icon :name="showCreate?'lucide:x':'lucide:plus'" aria-hidden="true" />{{showCreate?'Close':'New venue'}}</button></header>
