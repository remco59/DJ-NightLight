...
export const MOTION_TEMPLATES: Record<MotionTemplateKey, MotionTemplateDefinition> = {
  ...
  'neon-logo-reveal': {
    ...
    description: 'NightLight logo build: neon ring, slash rules, lightning crackle.',
    category: 'Brand',
    defaultDurationSeconds: 3,
    ...
    defaultExit: 'fade',
    fields: [
      text('line1', 'Top line', 14),
      text('line2', 'Bottom line', 14),
      text('tagline', 'Tagline', 50),
    ],
    defaults: { line1: 'NIGHT', line2: 'LIGHT', tagline: 'DJ · LIVE · ENERGY' },
  },
  'lightning-banner': {
    key: 'lightning-banner',
    label: 'Lightning Banner',
    description: 'Wide logo-style title between slanted neon rules with a bolt.',
    category: 'Titles',
    defaultDurationSeconds: 4,
    defaultAccent: 'ultraviolet',
    defaultEntrance: 'none',
    ...
    defaults: { title: 'NIGHTLIGHT', subtitle: 'LIVE ON THE DECKS TONIGHT' },
  },
  'electric-gig-poster': {
    key: 'electric-gig-poster',
    label: 'Electric Gig Poster',
    description: 'Neon ring date badge, headline slashed across, venue and CTA.',
    category: 'Announce',
    defaultDurationSeconds: 6,
    defaultAccent: 'ultraviolet',
    defaultEntrance: 'none',
  ...
  'now-playing': {
    key: 'now-playing',
    label: 'Now Playing',
    description: 'Track ID card with live EQ bars, framed by neon rules.',
    category: 'Titles',
  ...
  'bolt-transition': {
    ...
    description: 'Lightning strike and white flash to hide a cut between clips.',
    category: 'Brand',
  ...
  'neon-outro': {
    key: 'neon-outro',
    label: 'Neon Outro',
    description: 'End card with neon ring, handle and booking line.',
    category: 'Brand',
    defaultDurationSeconds: 4,
    defaultAccent: 'ultraviolet',
    defaultEntrance: 'zoom',
